...
<li><a href="pacman.php">PacMan in JavaScript</a></li>
	...
	<button id="save_the_program"><img src="https://icons.getbootstrap.com/assets/icons/floppy2-fill.svg" alt="Save the current program"></button>
...
<div>Maybe you are willing to <a href="survey.php" target="_blank">fill my survey about vegetarianism</a> and/or <a href="survey-superbacteria.php" target="_blank">my survey about superbacteria</a>? I am interested in hearing from highly educated people who do not specialize in biology.</div>
<?php endif?>
</div>
    ...
    <footer>
      ...
      <span id="Bachelor_thesis"
        ...
        mark for a Bachelor thesis at my school is somewhere between A and B (<i
          ...
          >vrlo dobar 4</i
        >
        - <i lang="hr">odli&ccaron;an 5</i>). And in case you are under any delusion I am the only one who tried doing this for my Bachelor thesis and got a bad mark, reality check: <a href="https://repozitorij.etfos.hr/object/etfos:5437/FILE0">here is another attempt at pretty much the same thing that got an even worse mark</a>. Kind of weird that academia
      ...
      EPILOGUE:
      <a
        href="https://repozitorij.etfos.hr/object/etfos:4489/FILE0"
