/*
 *  Compile on 64-bit Linux, like this:
 *  g++ -o bin2dec bin2dec.cpp -std=c++11
 *  Playing with inline assembly is a lot easier on Linux than on Windows.
 * */
...
extern "C" {
char binary_input[9];
int first_digit, binary_coded_decimal;
}
