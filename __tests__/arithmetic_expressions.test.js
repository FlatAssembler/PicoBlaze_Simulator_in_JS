...
const tokenizer = require(
    "../tokenizer.js"); // The parser depends on the tokenizer to work...
const list_of_directives = require(
    "../list_of_directives.js"); // ... and it also depends on the list of
                                 // directives (preprocessor directives and
                                 // mnemonics) being already loaded.
...
const cases = [
  ...
  [
    "Hexadecimal numbers composed entirely of decimal digits", "10 / 2",
    0x10 / 2
  ],
